...
- in the subpage _agents_, you find the included agent definition. Add you own agents on any other page in your graph. To change the built-in agents, use their name to override them.
  - Available Tools (currently not many) ad listed in the _Available Tool List_ in the _agents_ page.
- in the subpage _prompts_, you find the included prompt definitions. Similar to agents, you can add your own prompts on any other page in your graph. To change the built-in prompts, use their name to override them.
  - Except for the _system_ prompt, all prompts are written from the user's perspective, normally using I. They will be prepended before your message.
