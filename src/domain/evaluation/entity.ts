...
export const IssueSchema = z.object({
  ...
  impact: z
    ...
    .default("low")
    .describe("low: formatting/typos, medium: clarity/structure, high: factual/logical"),
  counterargument: z
    .string()
    .optional()
    .describe(
      "A counterargument arguing against this issue (e.g., why this might actually be intentional or beneficial).",
    ),
  ...
  user_feedback: z
    .array(z.lazy(() => UserFeedbackSchema))
    .optional()
    .describe("User replies and change proposals for this issue."),
...
export const CriterionResultSchema = z.object({
  criterion_id: z
    .string()
    .describe("Stable criterion ID from the rubric (e.g., 'clarity', 'factuality')."),
  ...
  confidence: z
    ...
    .max(100)
    .optional()
    .describe("Confidence score (0-100) for this rating, required if cognitive forcing is active"),
  issues: z
    .array(IssueSchema)
    .optional()
    .describe("List of specific issues found for this criterion."),
  user_feedback: z
    .array(UserFeedbackSchema)
    .optional()
...
export function createStrictEvaluationSchema(minSuggestions: number = 2) {
  return BlockEvaluationSchema.refine(
    (data) => {
