...
import type { FeedbackRating, CategoryRating, CriterionRating } from './feedback';
import { RatingValue, RatingCategory } from './value';
import { FeedbackText, CriterionName } from './feedback';
