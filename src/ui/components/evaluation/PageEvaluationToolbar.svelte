    ...
    async function handleClearAll() {
        try {
            ...
            await logseq.UI.showMsg(
                `Cleared ${clearedCount} evaluation properties`,
                "success",
            );
        } catch (e) {
            console.error(
                "[PageEvaluationToolbar] Failed to clear evaluations:",
                e,
            );
...
<div class="lda-eval-wrapper">
    ...
    {#if popupStyle}
        ...
        >
            <span class="eval-count-label"
                ><b>{evaluationState.count}</b> evaluations</span
            >
            <div class="sep"></div>
            <button
